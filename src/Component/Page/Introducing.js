        ...
        <div class="hero min-h-screen bg-base-200 m-0 p-0 introducing">
            <div class="hero-content flex-col lg:flex-row mt-20 ">
                ...
                <div className='lg:mr-20'>
                    ...
                    <p class="pt-6 text-white  font-bold lg:text-2xl"><FaArrowCircleRight className='icon tex-3xl' /> One-Click Application Submission</p>
                    <p class=" text-white font-bold lg:text-2xl"><FaArrowCircleRight className='icon tex-3xl' /> Real-Time Application </p>
